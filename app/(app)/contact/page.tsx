...
const Page = () => (
  <>
    <div className="relative mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:mt-40 lg:px-8">
      <div className="absolute right-8 top-8 -z-20 h-96 w-96 rotate-45 rounded-3xl bg-gradient-to-tr from-red-300 to-orange-500 blur-3xl filter"></div>
      <div className="absolute bottom-8 left-8 -z-20 h-64 w-64 rotate-45 bg-gradient-to-bl from-cyan-400 to-fuchsia-500 blur-3xl filter"></div>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-24 lg:grid-cols-2">
          ...
          <div className="relative mt-16 pt-16 before:absolute before:left-0 before:top-0 before:h-px before:w-6 before:bg-neutral-950 after:absolute after:left-8 after:right-0 after:top-0 after:h-px after:bg-neutral-950/10">
            ...
            <p className="mt-6 text-sm">
              We are always looking to improve our platform and services. If you
              have any feedback or suggestions, please fill out our Feedback
              Form.
            </p>
          </div>
        </div>
