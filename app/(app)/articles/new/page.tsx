...
const Page = () => {
  ...
  return (
    <article className="relative mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:mt-40 lg:px-8">
      ...
      <div className="absolute left-1/2 top-1/2 -z-20 h-[30rem] w-[30rem] rotate-45 rounded-full bg-gradient-to-t from-green-400 to-fuchsia-400 blur-3xl filter"></div>
