        ...
        <div className="mx-auto max-w-2xl lg:max-w-none">
          <div className="flex items-center justify-between">
            <Link aria-label="Home" href="/">
              <span className="font-display text-2xl font-extrabold tracking-wide text-neutral-950">
                CodeConnect
              </span>
            </Link>
            ...
            <div className="flex items-center gap-x-8">
              ...
              >
                <Bars2Icon className="size-8 fill-neutral-950" />
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-neutral-950 pb-16 pt-14">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:max-w-none">
              <div className="flex items-center justify-between">
                <Link aria-label="Home" href="/">
                  <span className="font-display text-2xl font-extrabold tracking-wide text-neutral-50">
                    CodeConnect
                  </span>
                </Link>
                ...
                <div className="flex items-center gap-x-8">
                  ...
                  >
                    <XMarkIcon className="size-8 fill-neutral-50" />
                  </button>
                </div>
              </div>
            </div>
